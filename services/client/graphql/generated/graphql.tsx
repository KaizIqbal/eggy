...
export type UpdatePermissionsMutation = (
  ...
  & { updatePermissions: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'permissions' | 'firstName' | 'lastName' | 'email'>
  )> }
);
...
export type UsersQuery = (
  ...
  & { users: Array<Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'firstName' | 'lastName' | 'email' | 'permissions'>
  )>> }
);
